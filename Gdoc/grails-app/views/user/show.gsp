	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.orgs}">
				<li class="fieldcontain">
					<span id="orgs-label" class="property-label"><g:message code="user.orgs.label" default="Orgs" /></span>
					
						<span class="property-value" aria-labelledby="orgs-label"><g:link controller="org" action="show" id="${userInstance?.orgs?.id}">${userInstance?.orgs?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${userInstance?.depts}">
				<li class="fieldcontain">
					<span id="depts-label" class="property-label"><g:message code="user.depts.label" default="Depts" /></span>
					
						<span class="property-value" aria-labelledby="depts-label"><g:link controller="dept" action="show" id="${userInstance?.depts?.id}">${userInstance?.depts?.encodeAsHTML()}</g:link></span>
