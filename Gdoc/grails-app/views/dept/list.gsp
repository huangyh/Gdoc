			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'dept.description.label', default: 'Description')}" />
				...
				<g:each in="${deptInstanceList}" status="i" var="deptInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: deptInstance, field: "description")}</td>
