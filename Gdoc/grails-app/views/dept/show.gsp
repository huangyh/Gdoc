	...
	<body>
		...
		<div id="show-dept" class="content scaffold-show" role="main">
			...
			<ol class="property-list dept">
				...
				<g:if test="${deptInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="dept.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${deptInstance}" field="description"/></span>
